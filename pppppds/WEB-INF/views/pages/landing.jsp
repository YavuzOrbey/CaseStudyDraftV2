...
<%@include file="../inc/nav.jsp" %>
  <div class='container'>
    <div id='video-container' class="mb-4 shadow-sm position-relative" >
      ...
      <video playsinline autoplay muted loop poster="${pageContext.request.contextPath}/resources/images/header-image.jpg" id="theVideo">
        <source src="${pageContext.request.contextPath}/resources/images/video.mp4" type="video/mp4">
      </video>
    </div>
  <div class='main-content'>
    ...
    <div class='section-2 row justify-content-around p-5'>
      ...
      <div class="col-12 col-md-4">
        <div class="card ">
          <img src="${pageContext.request.contextPath}/resources/images/pexels-brigitte-tohm-239581.jpg" class="card-img-top d-block" alt="macarons">
          <div class="card-body">
      ...
      <div class="col-12 col-md-4">
        <div class="card ">
          <img src="${pageContext.request.contextPath}/resources/images/pexels-ella-olsson-3026805.jpg" class="card-img-top d-block" alt="chicken satay">
          <div class="card-body">
      ...
      <div class="col-12 col-md-4">
        <div class="card ">
          <img src="${pageContext.request.contextPath}/resources/images/pexels-dzenina-lukac-1583884.jpg" class="card-img-top d-block" alt="french fries">
